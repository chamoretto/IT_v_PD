...
class Alert:
    ...
    @property
    def conv(self):
        return {"content": self.content, "type": self.alert_type}
...
def get_nice_table_page(table, href="*"):
    text = (
        f'<div class="container max-width-adaptive-lg">'
...
_public_template = Jinja2Templates("app/content/templates/public_temp")
_layout_env = Jinja2Templates("app/content/templates/layout")
